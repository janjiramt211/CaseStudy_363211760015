...
public class ExchangeAPI {
    ...
    private static String url_API = "https://v6.exchangerate-api.com/v6/748f078494e824825af09404/latest/";
    private  static JSONObject jsonObject;

    //connect server
    public boolean gatConnection(String base_code){
        String json = "";
        URL url = null;
    ...
    public double getEachPate(String newCurrency) {
        double eachRate = 0.0;
        try {
